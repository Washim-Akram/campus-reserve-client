...
const NavBar = () => {
  ...
  const navItems = (
    <>
      ...
      <li className="tooltip" data-tip="Colleges">
        <NavLink
          to="/colleges"
          className={({ isActive, isPending }) =>
            isPending ? "pending" : isActive ? "active" : ""
      ...
      <li className="tooltip" data-tip="Admission">
        <NavLink
          to="/admission"
          className={({ isActive, isPending }) =>
            isPending ? "pending" : isActive ? "active" : ""
      ...
      <li className="tooltip" data-tip="My College">
        <NavLink
          to="/myCollege"
          className={({ isActive, isPending }) =>
            isPending ? "pending" : isActive ? "active" : ""
  ...
  return (
    <div className="navbar bg-base-200 md:py-6 md:px-16 fixed top-0 w-full z-10">
